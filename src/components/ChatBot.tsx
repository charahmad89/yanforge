...
const botResponses: Record<string, string[]> = {
  ...
  portfolio: ["We'd be happy to share examples of our work! Please contact us at hello@yanforge.com, or reach us via WhatsApp, and we'll send you relevant case studies based on your industry."],
